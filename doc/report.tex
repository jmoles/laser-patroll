  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      x filter/.code={%
        ...
        \def\pgfmathresult{}
        \fi}]
      \addplot table [x=Threads, y=Time, col sep=comma] {basic.csv};
      \addplot table [x=Threads, y=Time, col sep=comma] {bitonic.csv};
      \addplot table [x=Threads, y=Time, col sep=comma] {merge.csv};
      \addplot table [x=Threads, y=Time, col sep=comma] {quick.csv};
    \end{axis}
  \end{tikzpicture}
\end{figure*}
